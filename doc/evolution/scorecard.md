...
8. Supervision integrity (pass rate, spec-before-execution invariant, evidence collection health)
...
- Supervision pass rate: rolling window of confirmed/partial vs failed verdicts
- Supervision evidence collection success rate and timeout frequency
- Supervision taxonomy distribution (healthy = mostly confirmable/partial, not deferred)
...
- no supervision pass-rate regression (rolling window must not decrease).
- evidence collection must not timeout systematically.
