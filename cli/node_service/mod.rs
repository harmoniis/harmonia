...
pub(super) fn write_pid_file() -> Result<PidGuard, Box<dyn std::error::Error>> {
...
pub(super) fn bind_socket(socket_path: &Path) -> Result<UnixListener, Box<dyn std::error::Error>> {
...
pub(super) fn send_local_payload(
