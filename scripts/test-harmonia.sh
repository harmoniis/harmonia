...
sbcl \
  ...
  --eval "(format t \"pgp=~D~%\" (hc #P\"$ROOT_DIR/target/release/libharmonia_pgp_identity.dylib\" \"harmonia_pgp_identity_healthcheck\"))" \
  --eval "(format t \"push=~D~%\" (hc #P\"$ROOT_DIR/target/release/libharmonia_push_sns.dylib\" \"harmonia_push_sns_healthcheck\"))" \
  ...
  --eval "(format t \"s3=~D~%\" (hc #P\"$ROOT_DIR/target/release/libharmonia_s3_sync.dylib\" \"harmonia_s3_sync_healthcheck\"))" \
  ...
  --eval "(format t \"webcash=~D~%\" (hc #P\"$ROOT_DIR/target/release/libharmonia_webcash_wallet.dylib\" \"harmonia_webcash_wallet_healthcheck\"))" \
  --quit
