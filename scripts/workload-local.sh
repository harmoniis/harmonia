...
(cffi:load-foreign-library #P"$ROOT_DIR/target/release/libharmonia_s3.dylib")
...
(cffi:defcfun ("harmonia_s3_upload_file" s3-upload) :int
...
echo "Local workload complete: all core test-lane systems validated."
