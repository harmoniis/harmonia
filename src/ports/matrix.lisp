...
(cffi:defcfun ("harmonia_harmonic_matrix_route_allowed_with_context" %hm-route-allowed-ctx) :int
  (from :string) (to :string) (signal :double) (noise :double)
  (security-weight :double) (dissonance :double))
...
(defun harmonic-matrix-route-with-context (from to &key
  ...
  (plusp (%hm-route-allowed-ctx from to
                                (coerce signal 'double-float)
                                (coerce noise 'double-float)
                                (coerce security-weight 'double-float)
                                (coerce dissonance 'double-float))))
