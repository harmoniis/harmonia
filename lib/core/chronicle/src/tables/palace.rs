//! MemPalace event audit log. Palace state itself is the mempalace actor's own
//! durable journal (`<HARMONIA_STATE_ROOT>/mempalace/*.sexp`); this table records
//! palace operations for observability only.
