...
pub(crate) use ops::{
    log_event, observe_route, register_edge, register_node, route_allowed, set_tool_enabled,
};
...
mod tests {
    ...
    fn graph_store_contract_returns_error() {
        ...
        let err =
            set_store("graph", Some("bolt://127.0.0.1:7687")).expect_err("graph should not be active yet");
