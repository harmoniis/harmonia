...
pub(crate) const EXPECTED: &[(&str, &str, &str)] = &[
    ...
    ("http3-frontend", "bind", "HARMONIA_HTTP3_BIND"),
    ("http3-frontend", "ca-cert", "HARMONIA_HTTP3_CA_CERT"),
    (
        "http3-frontend",
        "server-cert",
        "HARMONIA_HTTP3_SERVER_CERT",
    ),
    ("http3-frontend", "server-key", "HARMONIA_HTTP3_SERVER_KEY"),
    (
        "http3-frontend",
        "trusted-client-fingerprints-json",
        "HARMONIA_HTTP3_TRUSTED_CLIENT_FINGERPRINTS_JSON",
    ),
    (
        "http3-frontend",
        "max-concurrent-streams",
        "HARMONIA_HTTP3_MAX_CONCURRENT_STREAMS",
    ),
    (
        "http3-frontend",
        "session-idle-timeout-ms",
        "HARMONIA_HTTP3_SESSION_IDLE_TIMEOUT_MS",
    ),
    (
        "http3-frontend",
        "max-frame-bytes",
        "HARMONIA_HTTP3_MAX_FRAME_BYTES",
    ),
    ...
    ("sip-frontend", "kamailio-host", "HARMONIA_SIP_KAMAILIO_HOST"),
    ("sip-frontend", "kamailio-port", "HARMONIA_SIP_KAMAILIO_PORT"),
    ("sip-frontend", "realm", "HARMONIA_SIP_REALM"),
    ("sip-frontend", "agent-sip-uri", "HARMONIA_SIP_AGENT_URI"),
    ("sip-frontend", "ca-cert", "HARMONIA_SIP_CA_CERT"),
    ("sip-frontend", "client-cert", "HARMONIA_SIP_CLIENT_CERT"),
    ("sip-frontend", "client-key", "HARMONIA_SIP_CLIENT_KEY"),
    // harmonic matrix
    (
        "harmonic-matrix",
        "store-kind",
